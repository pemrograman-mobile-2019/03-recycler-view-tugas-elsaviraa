...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UniversitasAdapter adapterUniversitas = new UniversitasAdapter(universitasList);

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rv_Universitas);
        recyclerView.setAdapter(adapterUniversitas);
